...
#### 1. Bridge to `@modelcontextprotocol/conformance` *(value 5, effort M)*
...
#### 2. Streamable HTTP transport conformance audit *(value 5, effort S)*
...
#### 3. Per-operation timeouts *(value 4, effort S)*
...
#### 4. Better failure diagnostics *(value 4, effort S)*
...
#### 5. FastMCP integration *(value 5, effort S)*
...
#### 6. Server-type test packs *(value 4, effort M)*
...
A FastAPI-style "subclass and configure" pattern. Each pack ships with the
matching minimal demo server in `examples/`.

This is the strongest moat: maintainable specialist test packs are hard to
clone and create the network effect of "every new MCP server starts with the
matching pack."

#### 7. Performance probes *(value 3, effort M)*
...
#### 8. OpenTelemetry export *(value 3, effort S)*
...
#### 9. Wire-trace replay *(value 3, effort M)*
...
#### 10. Compliance score *(value 2, effort S)*
